<template>
    <div class="">
      <div class="mx-auto max-w-app px-4 pb-24 pt-16 sm:px-6 lg:px-8">
          ...
          <div>
            <div>
              ...
              <div class="mt-4">
                ...
                <div class="mt-1">
                  <input type="email" id="email-address" name="email-address" autocomplete="email" class="input" />
                </div>
              </div>
            </div>
            ...
            <div class="mt-10 border-t border-gray-200 pt-10">
              ...
              <div class="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                <div>
                  ...
                  <div class="mt-1">
                    <input type="text" id="first-name" name="first-name" autocomplete="given-name" class="input" />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div class="mt-1">
                    <input type="text" id="last-name" name="last-name" autocomplete="family-name" class="input" />
                  </div>
                </div>
                ...
                <div class="sm:col-span-2">
                  ...
                  <div class="mt-1">
                    <input type="text" name="address" id="address" autocomplete="street-address" class="input" />
                  </div>
                </div>
                ...
                <div class="sm:col-span-2">
                  ...
                  <div class="mt-1">
                    <input type="text" name="apartment" id="apartment" class="input" />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div class="mt-1">
                    <select id="country" name="country" autocomplete="country-name" class="input">
